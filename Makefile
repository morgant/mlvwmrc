...
pixmap:
	...
	curl -# -L https://raw.githubusercontent.com/morgant/vimb-icon/master/.github/images/vimb-transparent-512x512.png -o $(TEMP)/vimb.png
	convert $(TEMP)/vimb.png -resize 16x16\> $(PIXMAP)/vimb.xpm
